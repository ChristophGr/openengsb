        ...
        consumer.setMessageListener(new MessageListener() {
            ...
            public void onMessage(Message message) {
                ...
                try {
                    ...
                    LOGGER.info(text);
                    MethodCallRequest readValue = MAPPER.readValue(text, MethodCallRequest.class);
                    ...
                    MethodResult methodResult = new MethodResult(1, ReturnType.Void);
                    MethodResultMessage methodResultMessage =
                        new MethodResultMessage(methodResult, readValue.getCallId());
                    String writeValueAsString = MAPPER.writeValueAsString(methodResultMessage);

                    TextMessage message2 = session.createTextMessage(writeValueAsString);
