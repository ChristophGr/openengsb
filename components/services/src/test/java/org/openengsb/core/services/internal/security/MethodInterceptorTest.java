...
import org.openengsb.core.services.internal.security.internal.OpenEngSBAuthenticationToken;
import org.openengsb.core.services.internal.security.internal.RootSubjectHolder;
import org.openengsb.core.services.internal.security.internal.SecurityInterceptor;
...
public class MethodInterceptorTest extends AbstractOpenEngSBTest {
    ...
    public void testInvokeMethodAsRoot() throws Exception {
        ...
        org.openengsb.core.services.internal.security.SecurityContext.executeWithSystemPermissions(new Callable<Void>() {
            @Override
